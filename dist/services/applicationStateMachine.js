...
exports.ApplicationStateMachine = void 0;
class ApplicationStateMachine {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async transition(applicationId, newState, userId, reason) {
    ...
    async handleSideEffects(applicationId, state, tx) {
...
exports.ApplicationStateMachine = ApplicationStateMachine;
// The 18 allowed states per the MVP requirements
ApplicationStateMachine.ALLOWED_TRANSITIONS = {
    APPLIED: ['PENDING_REVIEW', 'AUTO_REJECTED', 'CANCELLED'],
...
//# sourceMappingURL=applicationStateMachine.js.map